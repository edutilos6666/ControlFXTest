...
import org.ddg.dao.WorkerDAOMemImplWithDelay;
...
public class TableViewResultTabContentWithDelay {
    ...
    public TableViewResultTabContentWithDelay() {
        dao = new WorkerDAOMemImplWithDelay(2000);
        root = buildContent();
    }
...
//                            setBackground(new Background(new BackgroundFill(Color.YELLOW, null, new Insets(1, 1, 1, 1))));
    ...
    private void addMockDataToTableView() {
        workerTableView.setCursor(Cursor.WAIT);
        ...
        task.setOnSucceeded(evt-> {
            workerTableView.setCursor(Cursor.DEFAULT);
        });
    ...
    private void refreshTable() {
        Scene scene = workerTableView.getScene();
